...
public class IntSearchTree {
    ...
    public int getMin(){
        // while the left most data in the tree is not empty
        while (overallRoot.left != null){
            // set the value of that number to the next left value
            overallRoot = overallRoot.left;
        }
        // return the number that is the left most number.
